...
using Pankaj_New_Code28.Services;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Pankaj_New_Code28", Version = "v1" });
...
builder.Services.AddTransient<Pankaj_New_Code28Context>();
